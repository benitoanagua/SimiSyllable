...
const addonVersion = storybook.devDependencies['@storybook/addon-essentials'];
...
if (major(addonVersion) !== 10) errors.push(`@storybook/addon-essentials must be major 10; found ${addonVersion}`);
